...
{#if isEditing}
	<div class="space-y-3">
		<div class="flex items-center justify-between">
			<p class="text-sm font-semibold text-secondary-text">Summary</p>
		...
		<div class="rounded-xs border border-border bg-card p-2">
			<p class="mb-1 text-sm font-medium text-secondary-text">Summary (SV)</p>
		...
		<div class="rounded-xs border border-border bg-card p-2">
			<p class="mb-1 text-sm font-medium text-secondary-text">Summary (EN)</p>
...
{:else}
	<div class="text-sm leading-relaxed text-secondary-text">
